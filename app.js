    ...
    .then(function(data) {
      ...
      .then(function(data) {
        ...
        return res.send({
          ...
          "text": ":notes: Added *" + track.name + "* by *" + track.artists[0].name + "* to the playlist."
        });
      }, function(err) {
